...
;const t="function"==typeof n
;return Object.getOwnPropertyNames(n).forEach((function(r){
  !Object.hasOwnProperty.call(n,r)||null===n[r]||"object"!=typeof n[r]&&"function"!=typeof n[r]||t&&("caller"===r||"callee"===r||"arguments"===r)||Object.isFrozen(n[r])||e(n[r])
})),n}class n{constructor(e){void 0===e.data&&(e.data={}),this.data=e.data}
  ignoreMatch(){this.ignore=!0}}function t(e){
  return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")
}function r(e,...n){const t={};for(const n in e)t[n]=e[n]
;return n.forEach((function(e){for(const n in e)t[n]=e[n]})),t}function a(e){
  return e.nodeName.toLowerCase()}const i=Object.freeze({__proto__:null,
  escapeHTML:t,inherit:r,nodeStream:function(e){const n=[];return function e(t,r){
    for(let i=t.firstChild;i;i=i.nextSibling)3===i.nodeType?r+=i.nodeValue.length:1===i.nodeType&&(n.push({
      event:"start",offset:r,node:i}),r=e(i,r),a(i).match(/br|hr|img|input/)||n.push({
      event:"stop",offset:r,node:i}));return r}(e,0),n},mergeStreams:function(e,n,r){
    let i=0,s="",o=[];function l(){
      return e.length&&n.length?e[0].offset!==n[0].offset?e[0].offset<n[0].offset?e:n:"start"===n[0].event?e:n:e.length?e:n
    }function c(e){s+="<"+a(e)+[].map.call(e.attributes,(function(e){
      return" "+e.nodeName+'="'+t(e.value)+'"'})).join("")+">"}function u(e){
      s+="</"+a(e)+">"}function g(e){("start"===e.event?c:u)(e.node)}
    for(;e.length||n.length;){let d=l()
...
const g="[a-zA-Z]\\w*",d="[a-zA-Z_]\\w*",h="\\b\\d+(\\.\\d+)?",f="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",p="\\b(0b[01]+)",m={
  ...
  },E=function(e,n,t={}){const a=r({className:"comment",begin:e,end:n,contains:[]
  },t);return a.contains.push(x),a.contains.push({className:"doctag",
    begin:"(?:TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):",relevance:0}),a
  },_=E("//","$"),w=E("/\\*","\\*/"),N=E("#","$");const y=Object.freeze({
  ...
  ;const e=this.regexes.map((e=>e[1]));this.matcherRe=n(function(e,n="|"){
    for(var t=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./,r=0,a="",i=0;i<e.length;i++){
      let s=r+=1,o=u(e[i]);for(i>0&&(a+=n),a+="(";o.length>0;){const l=t.exec(o)
;if(null==l){a+=o;break}
...
s.keywords&&(s.keywords=function(e,n){const t={}
;return"string"==typeof e?r("keyword",e):Object.keys(e).forEach((function(n){
  r(n,e[n])})),t;function r(e,r){
  n&&(r=r.toLowerCase()),r.split(" ").forEach((function(n){const r=n.split("|")
;t[r[0]]=[e,O(r[0],r[1])]}))}
...
;return function(t){
  let r=[],a=Object.create(null),i=Object.create(null),s=[],o=!0,l=/(^(<[^>]+>|\t|)+|\n)/gm,u="Could not find the language '{}', did you forget to load/include a language module?"
;const g={disableAutodetect:!0,name:"Plain text",contains:[]};let d={
    noHighlightRe:/^(no-?highlight)$/i,
    languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",
    tabReplace:null,useBR:!1,languages:null,__emitter:c};function h(e){
    return d.noHighlightRe.test(e)}function f(e,n,t,r){const a={code:n,language:e}
;N("before:highlight",a);const i=a.result?a.result:p(a.language,a.code,t,r)
;return i.code=a.code,N("after:highlight",i),i}function p(e,t,r,i){const s=t
;function l(e,n){const t=_.case_insensitive?n[0].toLowerCase():n[0]
;return Object.prototype.hasOwnProperty.call(e.keywords,t)&&e.keywords[t]}
  function c(){null!=y.subLanguage?function(){if(""!==O){let e=null
...
;M.addText(t),t="",L+=a,M.addKeyword(n[0],e)}else t+=n[0]
  ...
  t+=O.substr(e),M.addText(t)}(),O=""}function g(e){
    ...
    })}function h(e,t,r){let a=function(e,n){const t=e&&e.exec(n)
;return t&&0===t.index}(e.endRe,r);if(a){if(e["on:end"]){const r=new n(e)
;e["on:end"](t,r),r.ignore&&(a=!1)}if(a){for(;e.endsParent&&e.parent;)e=e.parent
  ;return e}}if(e.endsWithParent)return h(e.parent,t,r)}function f(e){
    return 0===y.matcher.regexIndex?(O+=e[0],1):(S=!0,0)}function b(e){
    const n=e[0],t=s.substr(e.index),r=h(y,e,t);if(!r)return B;const a=y
;a.skip?O+=n:(a.returnEnd||a.excludeEnd||(O+=n),c(),a.excludeEnd&&(O=n));do{
      y.className&&M.closeNode(),y.skip||y.subLanguage||(L+=y.relevance),y=y.parent
    }while(y!==r.parent)
    ;return r.starts&&(r.endSameAsBegin&&(r.starts.endRe=r.endRe),
    g(r.starts)),a.returnEnd?0:n.length}let v={};function x(t,a){const i=a&&a[0]
;if(O+=t,null==i)return c(),0
  ;if("begin"===v.type&&"end"===a.type&&v.index===a.index&&""===i){
    if(O+=s.slice(a.index,a.index+1),!o){const n=Error("0 width match regex")
;throw n.languageName=e,n.badRule=v.rule,n}return 1}
  if(v=a,"begin"===a.type)return function(e){const t=e[0],r=e.rule
...
;throw e.mode=y,e}if("end"===a.type){const l=b(a);if(l!==B)return l}
...
;j=e.index+n}return x(s.substr(j)),M.closeAllNodes(),M.finalize(),N=M.toHTML(),{
    ...
    n=n||d.languages||Object.keys(a);let t=function(e){const n={relevance:0,
        emitter:new d.__emitter(d),value:I(e),illegal:!1,top:g}
;return n.emitter.addText(e),n}(e),r=t
;return n.filter(E).filter(w).forEach((function(n){const a=p(n,e,!1);a.language=n,
    a.relevance>r.relevance&&(r=a),a.relevance>t.relevance&&(r=t,t=a)
    })),r.language&&(t.second_best=r),t}function b(e){
    return d.tabReplace||d.useBR?e.replace(l,(e=>"\n"===e?d.useBR?"<br>":e:d.tabReplace?e.replace(/\t/g,d.tabReplace):e)):e
  }function v(e){let n=null;const t=function(e){let n=e.className+" "
...
;if(h(t))return;N("before:highlightBlock",{block:e,language:t
  ...
  }),e.innerHTML=a.value,e.className=function(e,n,t){const r=n?i[n]:t,a=[e.trim()]
;return e.match(/\bhljs\b/)||a.push("hljs"),
  ...
  ;const e=document.querySelectorAll("pre code");r.forEach.call(e,v)}}
;function E(e){return e=(e||"").toLowerCase(),a[e]||a[i[e]]}
  function _(e,{languageName:n}){"string"==typeof e&&(e=[e]),e.forEach((e=>{i[e]=n
  }))}function w(e){const n=E(e);return n&&!n.disableAutodetect}function N(e,n){
    const t=e;s.forEach((function(e){e[t]&&e[t](n)}))}Object.assign(t,{highlight:f,
    ...
    registerLanguage:function(e,n){let r=null;try{r=n(t)}catch(n){
      if(console.error("Language definition for '{}' could not be registered.".replace("{}",e)),
      !o)throw n;console.error(n),r=g}
    r.name||(r.name=e),a[e]=r,r.rawDefinition=n.bind(null,t),
    r.aliases&&_(r.aliases,{languageName:e})},listLanguages:function(){
      return Object.keys(a)},getLanguage:E,registerAliases:_,
    requireLanguage:function(e){const n=E(e);if(n)return n
...
hljs.registerLanguage("c-like",function(){"use strict";return function(e){
  function t(e){return"(?:"+e+")?"}const n=e.COMMENT("//","$",{contains:[{
      begin:/\\\n/}]
...
hljs.registerLanguage("c",function(){"use strict";return function(e){
  const n=e.requireLanguage("c-like").rawDefinition()
...
hljs.registerLanguage("cpp",function(){"use strict";return function(e){
  const i=e.requireLanguage("c-like").rawDefinition();return i.disableAutodetect=!1,
...
hljs.registerLanguage("css",function(){"use strict";return function(e){const n={
...
hljs.registerLanguage("go",function(){"use strict";return function(e){const n={
...
hljs.registerLanguage("http",function(){"use strict";return function(e){
  const n="HTTP/[0-9\\.]+";return{name:"HTTP",aliases:["https"],illegal:"\\S",
...
hljs.registerLanguage("ini",function(){"use strict";function e(e){
  ...
  return n.map((n=>e(n))).join("")}return function(a){const s={className:"number",
    relevance:0,variants:[{begin:/([\+\-]+)?[\d]+_[\d_]+/},{begin:a.NUMBER_RE}]
  },i=a.COMMENT();i.variants=[{begin:/;/,end:/$/},{begin:/#/,end:/$/}];const t={
...
function i(...e){return e.map((e=>{
  return(n=e)?"string"==typeof n?n:n.source:null;let n})).join("")}
...
hljs.registerLanguage("json",function(){"use strict";return function(n){const e={
...
hljs.registerLanguage("kotlin",function(){"use strict";return function(e){
  const n={
      ...
      variants:[{begin:'"""',end:'"""(?=[^"])',contains:[s,i]},{begin:"'",end:"'",
        ...
        contains:[e.BACKSLASH_ESCAPE,s,i]}]};i.contains.push(t);const r={className:"meta",
...
hljs.registerLanguage("less",function(){"use strict";return function(e){
  const n="([\\w-]+|@{[\\w-]+})",a=[],s=[],t=function(e){return{className:"string",
...
;s.push(e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,t("'"),t('"'),e.CSS_NUMBER_MODE,{
  ...
  },{className:"meta",begin:"!important"});const c=s.concat({begin:"{",end:"}",
...
hljs.registerLanguage("makefile",function(){"use strict";return function(e){
  const i={className:"variable",variants:[{
...
hljs.registerLanguage("xml",function(){"use strict";return function(e){const n={
...
hljs.registerLanguage("markdown",function(){"use strict";return function(n){
  const e={begin:"<",end:">",subLanguage:"xml",relevance:0},a={
      ...
      contains:[],variants:[{begin:/\*(?!\*)/,end:/\*/},{begin:/_(?!_)/,end:/_/,
        relevance:0}]};i.contains.push(s),s.contains.push(i);let c=[e,a]
...
hljs.registerLanguage("nginx",function(){"use strict";return function(e){const n={
...
hljs.registerLanguage("perl",function(){"use strict";return function(e){const n={
    $pattern:/[\w.]+/,
  ...
  contains:a}}}());
hljs.registerLanguage("php",function(){"use strict";return function(e){const r={
...
hljs.registerLanguage("ruby",function(){"use strict";return function(e){
  const n="[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",a={
    ...
    }].concat(r);c.contains=d,b.contains=d;const g=[{begin:/^\s*=>/,starts:{end:"$",
...
hljs.registerLanguage("scss",function(){"use strict";return function(e){
  const t="@[a-z-]+",i={className:"variable",begin:"(\\$[a-zA-Z-][a-zA-Z0-9_-]*)\\b"
...
hljs.registerLanguage("sql",function(){"use strict";return function(e){
  const t=e.COMMENT("--","$");return{name:"SQL",case_insensitive:!0,
    illegal:/[<>{}*]/,contains:[{
...
hljs.registerLanguage("swift",function(){"use strict";return function(e){const i={

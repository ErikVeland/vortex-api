...
const SevenZip = __importStar(require("node-7z"));
        ...
        this.mMainInstallsLimit.do(() => {
            return new Promise((resolve, reject) => {
                ...
                const installationPromise = (0, errorHandling_1.withContext)('Installing', baseName, () => ((forceGameId !== undefined)
                    ...
                    return this.installInner(api, archivePath, tempPath, destinationPath, installGameId, installContext, installationZip, forceInstaller, fullInfo.choices, fileList, unattended);
                })
                    .then(result => {

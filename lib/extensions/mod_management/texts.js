...
const platformText_1 = require("../../util/platformText");
function getText(id, t) {
    switch (id) {
        case 'deployment':
            return t('When you install a mod through Vortex it is stored in a separate directory and has ' +
        ...
        case 'versionmatch':
            return t('A dependency rule can accept multiple versions of the same mod. In that case any ' +
        ...
        case 'namematch':
            return t('To be able to match multiple versions of the same file we need a way to identify a set ' +
        ...
        case 'version':
            return t('Version of the mod. A warning here means that the mod doesn\'t follow the recognized ' +
        ...
        case 'archivename':
            return t('The file name of the archive which was used to install this mod. If this field is ' +
                'empty, the mod is no longer paired with an archive, probably because the archive was ' +
                'deleted.');
        case 'variant':
            return t('If you have multiple copies of the same mod installed ' +
        ...
        case 'source':
            return t('The "Source" specifies where you got the mod. That source will be consulted for certain ' +
        ...
        case 'downloadspath': {
            ...
            const text = t('The downloads folder holds all mod archives you have downloaded with Vortex. It is shared across all '
            ...
            return (0, platformText_1.processPlatformText)(text, t);
        }
        case 'modspath': {
            return t('Vortex uses default paths to store mods you download and install.\n'
        ...
        case 'conflicts': {
            return t('A file conflict happens every time two mods contain the same file so one mod has to overwrite the other. '

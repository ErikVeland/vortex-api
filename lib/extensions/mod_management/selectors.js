...
exports.installPath = (0, reselect_1.createSelector)(installPathPattern, activeGameId_1.activeGameId, (inPaths, inGameMode) => {
...
exports.currentActivator = (0, reselect_1.createSelector)(activators, activeGameId_1.activeGameId, (inActivators, inGameMode) => {
...
exports.needToDeploy = (0, reselect_1.createSelector)(allNeedToDeploy, activeGameId_1.activeGameId, (inNeedToDeploy, inGameMode) => inNeedToDeploy[inGameMode]);

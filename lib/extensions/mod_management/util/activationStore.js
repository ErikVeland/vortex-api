...
exports.saveActivation = exports.loadActivation = exports.getManifest = exports.withActivationLock = exports.fallbackPurge = exports.fallbackPurgeType = exports.purgeDeployedFiles = void 0;
...
function saveActivation(gameId, modType, instance, gamePath, stagingPath, activation, activatorId) {
    ...
    return (activation.length === 0)
        ? fs.removeAsync(tagFilePath)
            .catch(() => undefined)
            .then(() => undefined)
        : bluebird_1.default.resolve((0, fsAtomic_1.writeFileAtomic)(tagFilePath, dataJSON))

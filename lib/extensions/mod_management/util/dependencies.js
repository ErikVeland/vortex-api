...
exports.findDownloadByRef = exports.lookupFromDownload = exports.findModByRef = void 0;
...
function gatherDependencies(rules, api, recommendations, progressCB) {
    ...
    return bluebird_1.default.all(requirements.map((rule) => bluebird_1.default.resolve(limit.do(() => gatherDependenciesGraph(rule, api, gameMode, recommendations)))
        .then((node) => {
        onProgress();

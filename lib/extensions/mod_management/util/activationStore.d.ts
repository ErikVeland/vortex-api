...
export declare function saveActivation(gameId: string, modType: string, instance: string, gamePath: string, stagingPath: string, activation: IDeployedFile[], activatorId?: string): Promise<void>;

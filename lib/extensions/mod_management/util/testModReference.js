...
exports.testModReference = exports.setResolvedCB = exports.isFuzzyVersion = exports.coerceToSemver = exports.safeCoerce = exports.sanitizeExpression = exports.referenceEqual = exports.idOnlyRef = void 0;
/* eslint-disable */
...
function testRef(mod, modId, ref, source, fuzzyVersion) {
    ...
    if ((ref.patches !== undefined && Object.keys(ref.patches).length > 0 && ref.tag !== undefined) && ((!_.isEqual(mod.patches, ref.patches)))) {
        if ((mod === null || mod === void 0 ? void 0 : mod.patches) !== undefined && mod.referenceTag !== ref.tag) {
            return false;
        }
    }

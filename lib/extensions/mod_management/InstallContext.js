...
class InstallContext {
    constructor(gameMode, api, silent) {
        ...
        this.mShowError = (message, details, allowReport, replace) => {
            ...
            return (0, message_1.showError)(dispatch, message, details, { allowReport, replace, attachments: [
                    {
                        id: 'log',
                        type: 'file',
    ...
    stopIndicator(mod) {
        ...
        (0, promise_helpers_1.promiseDelay)(50)
            .then(() => {
    ...
    startInstallCB(id, gameId, archiveId) {
        ...
        const isCollection = (nexusIds === null || nexusIds === void 0 ? void 0 : nexusIds.collectionSlug) != null && (nexusIds === null || nexusIds === void 0 ? void 0 : nexusIds.revisionId) != null;
    ...
    outcomeNotification(outcome, id, isEnabled, modName, mod) {
        ...
        const typeName = (type !== undefined)
            ...
            ? type.options.name
            : 'Mod';
        const nexusIds = (mod === null || mod === void 0 ? void 0 : mod.archiveId) != null ? (0, selectors_1.nexusIdsFromDownloadId)(this.mApi.getState(), mod.archiveId) : null;
        const isCollection = (nexusIds === null || nexusIds === void 0 ? void 0 : nexusIds.collectionSlug) != null && (nexusIds === null || nexusIds === void 0 ? void 0 : nexusIds.revisionId) != null;
        switch (outcome) {
            case 'success':
                if (nexusIds != null && !isCollection) {

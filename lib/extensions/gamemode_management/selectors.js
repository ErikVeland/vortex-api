...
exports.currentGame = (0, reselect_1.createSelector)(knownGames, activeGameId_1.activeGameId, (games, currentGameMode) => games.find(game => game.id === currentGameMode));
...
function gameName(state, gameId) {
    ...
    const known = (0, storeHelper_1.getSafe)(state, ['session', 'gameMode', 'known'], [])

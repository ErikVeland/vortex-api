...
exports.suggestStagingPath = exports.searchDiscovery = exports.discoverRelativeTools = exports.assertToolDir = exports.quickDiscovery = exports.quickDiscoveryTools = void 0;
    ...
    const attemptVerification = (retryCount = 0) => {
        return verifyToolDir(tool, testPath)
            ...
            if (err.code === 'ENOENT' && retryCount < 2 && process.platform === 'darwin') {
                ...
                return bluebird_1.default.delay(150 * (retryCount + 1))

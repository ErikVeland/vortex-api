    ...
    return (api, profileIdIn, modIdsIn, enableIn, optionsIn) => {
        ...
        if (ppFunc === undefined) {
            ppFunc = api.withPrePost('enable-mods', (profileId, modIds, enable, options) => {
                try {
                    (0, log_1.log)('info', 'mods enablement requested', {
                        profileId,
                        modIds,
                        enable,
                        options,
                ...
                if (modIds.length > 0) {
                    ...
                    if (profile !== undefined) {
                        ...
                        try {
                            (0, log_1.log)('debug', 'mods enablement applied', {
                                profileId,
                    ...
                    try {
                        (0, log_1.log)('debug', 'mods enablement noop', { profileId, enable });
                    }
                    catch (_) { /* noop */ }
                }
        ...
        }
        {
            ...
            return ppFunc(profileIdIn, willChange, enableIn, optionsIn)
                .then(() => {
                try {
                    (0, log_1.log)('info', 'mods enablement completed', {
                ...
                .catch(err => {
                try {
                    (0, log_1.log)('error', 'mods enablement failed', {
                        profileId: profileIdIn,
                        enabled: enableIn,

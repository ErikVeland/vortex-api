 ...
 */
function retryValidationOperation(operation, maxRetries = 5, baseDelayMs = 200, maxDelayMs = 5000, operationName = 'validation operation', shouldRetry) {
...
function waitForExtractionCompletion(extractionPath, maxWaitMs = 15000) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function validateExtractionCompleteness(extractionPath, maxWaitMs = 10000) {
    return __awaiter(this, void 0, void 0, function* () {
        const platformFactor = (process.platform === 'darwin') ? 1.5 : 1;
        const effectiveMaxWaitMs = Math.ceil(maxWaitMs * platformFactor);
        const startTime = Date.now();

...
function retryNetworkOperation(operation, retries, baseDelayMs, maxDelayMs, description, isRetryable) {
    ...
    const doAttempt = () => {
        return bluebird_1.default.resolve()
            ...
            return bluebird_1.default.delay(delay).then(doAttempt);
        });
    };
    return doAttempt();
}
...
function downloadFile(url, outputPath) {
    ...
    return retryNetworkOperation(() => bluebird_1.default.resolve((0, network_1.rawRequest)(interceptedUrl))
...
function downloadGithubRawRecursive(repo, source, destination) {
    ...
    return retryNetworkOperation(() => bluebird_1.default.resolve((0, network_1.rawRequest)(apiUrl, { encoding: 'utf8' }))

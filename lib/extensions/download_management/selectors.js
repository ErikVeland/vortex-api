...
exports.downloadPath = (0, reselect_1.createSelector)(downloadPathPattern, activeGameId_1.activeGameId, (inPath, inGameId) => (0, getDownloadPath_1.default)(inPath, inGameId));
...
function downloadPathForGame(state, gameId) {
    var _a;
    return downloadPathForGameImpl(state, (_a = gameId !== null && gameId !== void 0 ? gameId : (0, activeGameId_1.activeGameId)(state)) !== null && _a !== void 0 ? _a : '__invalid');
}

...
class MyOverlay extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(react_bootstrap_1.Overlay, Object.assign({ placement: placement, onEnter: this.onEnter, ref: this.props.triggerRef, container: document.body }, relayProps), this.props.children));
    }
}

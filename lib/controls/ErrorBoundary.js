...
exports.safeCallbacks = exports.ErrorContext = void 0;
            ...
            React.createElement(react_bootstrap_1.Alert, { className: 'render-failure', bsStyle: 'danger' },
                ...
                React.createElement("div", { className: 'render-failure-buttons' },
                    ((0, errorHandling_1.isOutdated)() || (0, errorHandling_1.didIgnoreError)())
                        ? null
                        : React.createElement(react_bootstrap_1.Button, { onClick: this.report }, t('Report')),
                    React.createElement(react_bootstrap_1.Button, { onClick: this.retryRender }, t('Retry'))),
                (onHide !== undefined)
                    ? (React.createElement(TooltipControls_1.IconButton, { className: 'error-boundary-close', tooltip: t('Hide'), icon: 'close', onClick: onHide }))
                    : null))) : null;
    }
}

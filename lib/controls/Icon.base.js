...
class Icon extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("svg", { preserveAspectRatio: 'xMidYMid meet', className: classes.join(' '), style: effectiveStyle, ref: /*this.props.rotate && (this.mCurrentSize === undefined) ? this.setRef : */ undefined, onContextMenu: this.props.onContextMenu },

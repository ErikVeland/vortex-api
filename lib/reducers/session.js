...
exports.sessionReducer = exports.makeExeId = void 0;
...
exports.sessionReducer = {
    reducers: {
        ...
        [actions.setProgress]: (state, payload) => (0, storeHelper_1.setSafe)(state, ['progress', payload.group, payload.progressId], { text: payload.text, percent: Math.round(payload.percent) }),

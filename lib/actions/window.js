 ...
 */
exports.setMaximized = (0, safeCreateAction_1.default)('SET_MAXIMIZED', (value) => value);
exports.setZoomFactor = (0, safeCreateAction_1.default)('SET_ZOOM_FACTOR', (factor) => factor);
exports.setTabsMinimized = (0, safeCreateAction_1.default)('SET_TABS_MINIMIZED', (minimized) => minimized);
exports.setCustomTitlebar = (0, safeCreateAction_1.default)('SET_CUSTOM_TITLEBAR', (enabled) => enabled);

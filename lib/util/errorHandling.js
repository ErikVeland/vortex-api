...
function nexusReport(hash, type, error, labels, context, oauthToken, reporterProcess, sourceProcess, attachment) {
    ...
    return Promise.resolve(Nexus.createWithOAuth(oauthCredentials, config, 'Vortex', (0, application_1.getApplication)().version, undefined))
        ...
        .then(() => (0, opn_1.default)(`${constants_1.NEXUS_BASE_URL}/crash-report/?key=${referenceId}`).catch(() => null))
        .catch(err => {

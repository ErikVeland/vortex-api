...
exports.processPlatformText = exports.getStructuredPlatformText = exports.getPlatformText = void 0;
 ...
 */
function getPlatformText(text, platform) {
    const currentPlatform = platform || (0, platform_1.getCurrentPlatform)();
...
exports.getPlatformText = getPlatformText;
/**
 ...
 * @returns Platform-appropriate text
 */
function getStructuredPlatformText(options, t) {
...
exports.getStructuredPlatformText = getStructuredPlatformText;
/**
 ...
 */
function processPlatformText(text, t) {
    const platform = (0, platform_1.getCurrentPlatform)();
...
exports.processPlatformText = processPlatformText;

...
exports.renderError = exports.prettifyNodeErrorMessage = exports.showError = exports.bundleAttachment = exports.showInfo = exports.showActivity = exports.showSuccess = exports.calcDuration = void 0;
/* disable-eslint */
...
function zipFiles(files) {
    ...
    return new bluebird_1.default((resolve, reject) => {
        ...
        .then(tmpPath => (0, archive_1.addToArchive)(tmpPath, files, { ssw: true })
        .then(() => tmpPath));
}

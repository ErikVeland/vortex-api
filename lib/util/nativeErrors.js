...
exports.decodeSystemError = void 0;
const platform_1 = require("./platform");
function decodeSystemError(err, filePath) {
    var _a;
    const code = (_a = err['systemCode']) !== null && _a !== void 0 ? _a : err['nativeCode'];
    if ((code === undefined) || (!(0, platform_1.isWindows)())) {
        return undefined;
    }
    if (code === 225) {
        return {
        ...
        || ((code === 1359) && (filePath !== null && filePath !== void 0 ? filePath : '').toLowerCase().includes('onedrive'))) {
        return {
...
exports.decodeSystemError = decodeSystemError;

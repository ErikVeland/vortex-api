...
exports.Source = exports.Content = exports.Campaign = exports.Section = exports.wrapExtCBSync = exports.wrapExtCBAsync = exports.isFunction = exports.batchDispatch = exports.semverCoerce = exports.replaceRecursive = exports.toBlue = exports.delayed = exports.unique = exports.withTmpDir = exports.makeUniqueByKey = exports.makeUnique = exports.toPromise = exports.flatten = exports.isMajorDowngrade = exports.INVALID_FILENAME_CHARACTERS = exports.INVALID_FILENAME_RE = exports.INVALID_FILEPATH_CHARACTERS = exports.isPathValid = exports.sanitizeFilename = exports.isFilenameValid = exports.delay = exports.timeout = exports.escapeRE = exports.deBOM = exports.sanitizeCSSId = exports.ciEqual = exports.isReservedDirectory = exports.isChildPath = exports.getAllPropertyNames = exports.decodeHTML = exports.encodeHTML = exports.timeToString = exports.pad = exports.largeNumToString = exports.bytesToString = exports.spawnSelf = exports.makeQueue = exports.restackErr = exports.objDiff = exports.truthy = exports.isNullOrWhitespace = exports.midClip = exports.setdefault = exports.sum = exports.countIf = void 0;
exports.makeOverlayableDictionary = exports.Overlayable = exports.parseBool = exports.filteredEnvironment = exports.nexusModsURL = void 0;
/* eslint-disable */
    ...
    if ((typeof (lhs) === 'object') && (typeof (rhs) === 'object')) {
        Object.keys(lhs || {}).forEach(key => {
            ...
            if (!Object.prototype.hasOwnProperty.call(rhs, key)
                ...
                const sub = objDiff((_a = lhs === null || lhs === void 0 ? void 0 : lhs[key]) !== null && _a !== void 0 ? _a : {}, (_b = rhs === null || rhs === void 0 ? void 0 : rhs[key]) !== null && _b !== void 0 ? _b : {});
                if (sub === null || sub === undefined) {
                    res['-' + key] = (_c = lhs === null || lhs === void 0 ? void 0 : lhs[key]) !== null && _c !== void 0 ? _c : null;
                    res['+' + key] = (_d = rhs === null || rhs === void 0 ? void 0 : rhs[key]) !== null && _d !== void 0 ? _d : null;
                }
...
function isChildPath(child, parent, normalize) {
    if (normalize === undefined) {
        normalize = (input) => (0, platform_1.isWindows)()
 ...
 */
const INVALID_FILEPATH_CHARACTERS = (0, platform_1.isWindows)()
    ? ['/', '?', '*', ':', '|', '"', '<', '>']
    : [];
...
const RESERVED_NAMES = new Set((0, platform_1.isWindows)()
    ? [
        'CON', 'PRN', 'AUX', 'NUL',
...
function isPathValid(input, allowRelative = false) {
    ...
    if ((0, platform_1.isWindows)() && input.startsWith('\\') && !input.startsWith('\\\\')) {
        return false;
    }
    ...
    for (const segment of rawSegments) {
        ...
        if (segment === '' || ((0, platform_1.isWindows)() && isDriveLetter(segment))) {
            continue;
        }
    ...
    const isUNC = (0, platform_1.isWindows)() && input.startsWith('\\\\');
    if (isUNC) {
    ...
    const hasDriveLetter = (0, platform_1.isWindows)() && isDriveLetter(segments[0]);
...
(function (Campaign) {
    ...
    Campaign["ViewCollection"] = "view_collection";
    Campaign["ViewCollectionAsCurator"] = "view_collection_as_curator";
...
var Source;
(function (Source) {
    Source["CollectionsAd"] = "collections_ad";
...
function nexusModsURL(reqPath, options) {
    ...
    const parameters = (_a = options === null || options === void 0 ? void 0 : options.parameters) !== null && _a !== void 0 ? _a : [];
    ...
    const urlParameters = {
        protocol: constants_1.NEXUS_PROTOCOL,
        host: sectionHost(options === null || options === void 0 ? void 0 : options.section),
    };
    if (reqPath.length > 0) {

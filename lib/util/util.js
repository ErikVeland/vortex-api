...
exports.Overlayable = exports.Source = exports.Content = exports.Campaign = exports.Section = exports.INVALID_FILENAME_CHARACTERS = exports.INVALID_FILENAME_RE = exports.INVALID_FILEPATH_CHARACTERS = void 0;
...
function timeout(prom, delayMS, options) {
    ...
    const doTimeout = () => {
        ...
        if ((options === null || options === void 0 ? void 0 : options.throw) === true) {
            return Promise.reject(new CustomErrors_1.TimeoutError());
        }
        else {
            return undefined;
        }
    ...
    const onTimeExpired = () => {
        ...
        if ((options === null || options === void 0 ? void 0 : options.queryContinue) !== undefined) {
            return options === null || options === void 0 ? void 0 : options.queryContinue().then(requestContinue => {
                if (requestContinue) {
                    delayMS *= 2;
                    return (0, promise_helpers_1.promiseDelay)(delayMS, undefined).then(onTimeExpired);
                }
                else {
                    return doTimeout();
                }
    ...
    return Promise.race([prom, (0, promise_helpers_1.promiseDelay)(delayMS, undefined).then(onTimeExpired)])
        .finally(() => {
        resolved = true;
...
function delay(timeoutMS) {
    return (0, promise_helpers_1.promiseDelay)(timeoutMS, undefined);
}
/**
...
function wrapExtCBAsync(cb, extInfo) {
    return (...args) => {
        var _a, _b;
        try {
            return (_b = (_a = Promise.resolve(cb(...args))).catch) === null || _b === void 0 ? void 0 : _b.call(_a, err => {

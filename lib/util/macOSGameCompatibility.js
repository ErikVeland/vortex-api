...
exports.validateBalatroPlatformCompatibility = exports.validateExecutableNameMapping = exports.mapWindowsExecutableToMacOS = exports.getExecutableNameMappings = exports.registerCustomExecutableNameMapping = exports.detectSteamModdedForBalatro = exports.detectLovelyInjectorForBalatro = exports.hasWindowsOnlyFrameworks = exports.hasWindowsOnlyDirectories = exports.hasWindowsOnlyFiles = exports.createMacOSCompatibilityErrorMessage = exports.validateCyberpunkMacOSCompatibility = exports.getCyberpunkRedscriptAwareExecutable = exports.GameProcessManager = exports.normalizeGamePathForMacOS = exports.getExecutableFromAppBundle = exports.findMacOSAppBundle = exports.interceptDownloadURLForMacOS = exports.getMacOSArchitecture = exports.getExecutablePathForPlatform = exports.validateRequiredFilesWithMacOSCompat = exports.checkFileWithMacOSFallback = exports.getMacOSGameFix = exports.MACOS_GAME_FIXES = exports.registerCustomURLMapping = exports.validateURLMapping = void 0;
const path = __importStar(require("path"));
const fs = __importStar(require("fs-extra"));
const os = __importStar(require("os"));
const child_process = __importStar(require("child_process"));
const log_1 = require("./log");
const executablePathCache = new Map();
...
exports.MACOS_GAME_FIXES = MACOS_GAME_FIXES;
 ...
 */
function validateURLMapping(mapping, testUrls) {
    const errors = [];
    const testResults = [];
    try {
        // Basic validation
        ...
        if (testUrls && testUrls.length > 0 && mapping.windowsPattern && mapping.getMacOSUrl) {
            for (const testUrl of testUrls) {
                try {
                    ...
                    const result = { url: testUrl, matches };
                    if (matches) {
...
exports.validateURLMapping = validateURLMapping;
/**
 ...
 */
function registerCustomURLMapping(mapping, validate = true) {
    try {
        // Validate mapping if requested
        if (validate) {
            const validation = validateURLMapping(mapping);
            if (!validation.success) {
                (0, log_1.log)('error', 'URL mapping validation failed', {
        ...
        (0, log_1.log)('info', 'Registering custom URL mapping for community extension', {
            description: mapping.description,
            pattern: mapping.windowsPattern.toString()
        });
        // Check if mapping already exists
        const existingIndex = customURLMappings.findIndex(existing => existing.windowsPattern.toString() === mapping.windowsPattern.toString());
        if (existingIndex >= 0) {
            (0, log_1.log)('warn', 'Overriding existing URL mapping', {
                description: mapping.description,
        ...
        (0, log_1.log)('error', 'Failed to register custom URL mapping', {
            error: error.message,
            description: mapping.description
        });
        return false;
...
exports.registerCustomURLMapping = registerCustomURLMapping;
/**
 * Static download URL mappings for macOS compatibility
 */
const STATIC_DOWNLOAD_URL_MAPPINGS = [
    {
    ...
    },
    {
        ...
        getMacOSUrl: (windowsUrl) => {
            try {
                ...
                (0, log_1.log)('info', 'Converting Lovely injector URL for Balatro macOS compatibility', {
                ...
                if (windowsUrl.includes('/latest/download/')) {
                    ...
                    (0, log_1.log)('info', 'Generated latest download URL for Lovely injector (Balatro)', {
                        macUrl,
                        architecture: arch,
                        originalUrl: windowsUrl
                    });
                    ...
                    (0, log_1.log)('info', 'Generated versioned download URL for Lovely injector (Balatro)', {
                        macUrl,
                        version,
                        architecture: arch,
                        originalUrl: windowsUrl
                ...
                (0, log_1.log)('error', 'Error converting Lovely injector URL for Balatro, returning original', {
                    url: windowsUrl,
                    error: error.message,
                    stack: error.stack
                });
    ...
    },
    {
        ...
        getMacOSUrl: (windowsUrl) => {
            try {
                ...
                (0, log_1.log)('debug', 'Processing Steammodded URL for Balatro', {
                    originalUrl: windowsUrl,
                ...
                (0, log_1.log)('warn', 'Error processing Steammodded URL, returning original', {
                    url: windowsUrl,
                    error: error.message
                });
                return windowsUrl;
    ...
    // Enhanced generic pattern for common Windows to macOS conversions
    {
        ...
        getMacOSUrl: (windowsUrl) => {
            try {
                (0, log_1.log)('debug', 'Applying generic Windows to macOS URL conversion', {
                    originalUrl: windowsUrl,
                ...
                (0, log_1.log)('debug', 'Generic URL conversion result', {
                    originalUrl: windowsUrl,
                    convertedUrl: macUrl,
                ...
                (0, log_1.log)('warn', 'Error in generic Windows to macOS URL conversion, returning original', {
                    url: windowsUrl,
                    error: error.message
                });
                return windowsUrl;
 ...
 */
function getMacOSGameFix(gameId) {
    return MACOS_GAME_FIXES.find(fix => fix.gameId === gameId);
}
exports.getMacOSGameFix = getMacOSGameFix;
/**
 * Check if a file exists, with macOS-specific fallbacks
 */
function checkFileWithMacOSFallback(basePath, fileName, gameId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const normalizedPath = yield normalizeGamePathForMacOS(basePath, gameId, fileName);
            if (normalizedPath && normalizedPath !== basePath) {
                return yield fs.pathExists(normalizedPath);
            }
            ...
            if (fix && fileName === fix.windowsExecutable) {
                ...
                const appBundlePath = yield findMacOSAppBundle(basePath, fix.macOSAppBundle);
                if (appBundlePath) {
                    return true;
                }
                ...
                if (fix.alternativeFiles) {
                    for (const altFile of fix.alternativeFiles) {
                        if (yield fs.pathExists(path.join(basePath, altFile))) {
                            return true;
                        }
                    }
                }
            ...
            const error = err;
            (0, log_1.log)('debug', 'Error checking file existence', { basePath, fileName, gameId, error: error.message });
            return false;
        }
    });
}
exports.checkFileWithMacOSFallback = checkFileWithMacOSFallback;
/**
 * Validate required files with macOS compatibility
 */
function validateRequiredFilesWithMacOSCompat(basePath, requiredFiles, gameId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const file of requiredFiles) {
            const exists = yield checkFileWithMacOSFallback(basePath, file, gameId);
...
exports.validateRequiredFilesWithMacOSCompat = validateRequiredFilesWithMacOSCompat;
/**
 * Synchronous version of findMacOSAppBundle for use in StarterInfo constructor
 */
function findMacOSAppBundleSync(basePath, appBundleName) {
    try {
        ...
        const error = err;
        (0, log_1.log)('debug', 'Error finding macOS app bundle (sync)', { basePath, appBundleName, error: error.message });
        return null;
    }
}
/**
 ...
 */
function getExecutablePathForPlatform(basePath, gameId, windowsExecutable) {
    ...
    try {
        ...
        if (pathNormalization && typeof pathNormalization.normalizePathForCompatibility === 'function') {
            const normalizedPath = pathNormalization.normalizePathForCompatibility(path.join(basePath, windowsExecutable), { gameId, targetPlatform: 'darwin' });
            ...
            if (fs.existsSync(normalizedPath)) {
                ...
                (0, log_1.log)('debug', 'Found executable using enhanced path normalization', {
                    gameId,
                    windowsExecutable,
                    normalizedPath
                });
        ...
        (0, log_1.log)('debug', 'Could not use enhanced path normalization for executable, falling back to basic implementation', {
            error: err.message,
            basePath,
            windowsExecutable,
            gameId
    ...
    if (fix && windowsExecutable === fix.windowsExecutable) {
        ...
        if (appBundlePath) {
            ...
            (0, log_1.log)('debug', 'Found macOS app bundle for game', {
                gameId,
                windowsExecutable,
            ...
            for (const altFile of fix.alternativeFiles) {
                ...
                try {
                    if (fs.existsSync(altPath)) {
                        ...
                        (0, log_1.log)('debug', 'Found alternative executable for game', {
                            gameId,
                            windowsExecutable,
    ...
    if (windowsExecutable.endsWith('.exe')) {
        ...
        if (appBundlePath) {
            ...
            (0, log_1.log)('debug', 'Found macOS app bundle using pattern matching', {
                gameId,
                windowsExecutable,
                macOSPath: appBundlePath
            });
        ...
        try {
            if (fs.existsSync(baseNamePath)) {
                ...
                (0, log_1.log)('debug', 'Found executable using base name', {
                    gameId,
                    windowsExecutable,
    ...
    (0, log_1.log)('debug', 'No macOS alternative found, using original path', {
        gameId,
        windowsExecutable,
        fallbackPath: result
    });
...
exports.getExecutablePathForPlatform = getExecutablePathForPlatform;
/**
...
function getMacOSArchitecture() {
    try {
        ...
        (0, log_1.log)('debug', 'Detecting macOS architecture', {
            osArch: arch,
        ...
        if (arch === 'arm64' || arch === 'aarch64') {
            (0, log_1.log)('debug', 'Detected Apple Silicon (ARM64) architecture');
            return 'arm64';
        }
            ...
            try {
                ...
                if (result.stdout && result.stdout.trim() === '1') {
                    (0, log_1.log)('debug', 'System reports ARM64 hardware via sysctl, overriding process architecture');
                    return 'arm64';
                }
                // Fallback to arch command
                result = child_process.spawnSync('arch', [], { encoding: 'utf8' });
                if (result.stdout && result.stdout.trim() === 'arm64') {
                    (0, log_1.log)('debug', 'System reports ARM64, overriding process architecture');
                    return 'arm64';
                }
                ...
                if (result.stdout && (result.stdout.includes('Apple M') || result.stdout.includes('Apple Silicon'))) {
                    (0, log_1.log)('debug', 'System reports Apple Silicon via system_profiler, overriding process architecture');
                    return 'arm64';
                }
            }
            catch (sysError) {
                (0, log_1.log)('debug', 'Could not determine system architecture via command', {
                    error: sysError.message
                });
            }
            (0, log_1.log)('debug', 'Detected Intel (x64) architecture');
            return 'x64';
        }
        else {
            // Fallback for unknown architectures
            (0, log_1.log)('warn', 'Unknown architecture detected, defaulting to x64', { arch });
            return 'x64';
        }
    }
    catch (error) {
        (0, log_1.log)('error', 'Error detecting macOS architecture, defaulting to x64', {
            error: error.message
        });
        return 'x64';
    }
}
exports.getMacOSArchitecture = getMacOSArchitecture;
/**
 * Intercept and modify download URLs for macOS compatibility
 */
function interceptDownloadURLForMacOS(url) {
    // Always log URL interception attempts for debugging
    (0, log_1.log)('debug', 'URL interception called', {
        url: url,
        platform: os.platform(),
        architecture: getMacOSArchitecture() // Use enhanced detection
    });
    if (os.platform() !== 'darwin') {
        (0, log_1.log)('debug', 'Not on macOS, returning original URL', { url });
        return url;
    }
    // Ensure all URLs pass through interception, not just pattern-matched ones
    for (const mapping of getAllURLMappings()) {
        (0, log_1.log)('debug', 'Testing URL against pattern', {
            url: url,
            pattern: mapping.windowsPattern.toString(),
        ...
        if (mapping.windowsPattern.test(url)) {
            ...
            (0, log_1.log)('info', 'Intercepted Windows download URL for macOS compatibility', {
                originalUrl: url,
                macUrl: macUrl,
                description: mapping.description,
    ...
    (0, log_1.log)('debug', 'No URL mapping found, returning original URL', { url });
    return url;
}
exports.interceptDownloadURLForMacOS = interceptDownloadURLForMacOS;
/**
 ...
 */
function findMacOSAppBundle(basePath, appBundleName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const fullPath = path.join(basePath, appBundleName);
            ...
            for (const variation of variations) {
                const variationPath = path.join(basePath, `${variation}.app`);
                if (yield fs.pathExists(variationPath)) {
                    return variationPath;
                }
            }
            return null;
            ...
            const error = err;
            (0, log_1.log)('debug', 'Error finding macOS app bundle', { basePath, appBundleName, error: error.message });
            return null;
        }
    });
}
exports.findMacOSAppBundle = findMacOSAppBundle;
/**
...
function getExecutableFromAppBundle(appBundlePath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const error = err;
            (0, log_1.log)('debug', 'Error getting executable from app bundle', { appBundlePath, error: error.message });
            return null;
        }
    });
}
exports.getExecutableFromAppBundle = getExecutableFromAppBundle;
/**
 ...
 */
function normalizeGamePathForMacOS(basePath, gameId, expectedExecutable) {
    return __awaiter(this, void 0, void 0, function* () {
        if (process.platform !== 'darwin') {
        ...
        try {
            ...
            if (pathNormalization && typeof pathNormalization.normalizePathForCompatibility === 'function') {
                ...
                if (expectedExecutable) {
                    const normalizedExecutable = pathNormalization.normalizePathForCompatibility(path.join(basePath, expectedExecutable), { gameId, targetPlatform: 'darwin' });
                    // Check if the normalized executable path exists
                    if (yield fs.pathExists(normalizedExecutable)) {
                    ...
                    if (yield fs.pathExists(joinedPath)) {
                        return joinedPath;
                    }
                }
                // If we only have a base path, return the normalized version
                if (yield fs.pathExists(normalizedBasePath)) {
                    return normalizedBasePath;
                }
            }
        }
        catch (err) {
            (0, log_1.log)('debug', 'Could not use enhanced path normalization, falling back to basic implementation', {
                error: err.message,
                basePath,
                gameId
            });
        ...
        if (expectedExecutable) {
            ...
            if (expectedExecutable.endsWith('.exe')) {
                ...
                const appBundleName = `${baseName}.app`;
                const appBundlePath = yield findMacOSAppBundle(basePath, appBundleName);
                if (appBundlePath) {
                    return appBundlePath;
                }
                // Try just the base name as an executable
...
exports.normalizeGamePathForMacOS = normalizeGamePathForMacOS;
/**
 ...
 */
function hasRedscript(gamePath) {
    if (process.platform !== 'darwin') {
 ...
 */
function setupSteamRedscript(gamePath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const path = require('path');
            ...
            if (fileExists(executablePath) && !fileExists(realExecutablePath)) {
                yield fs.rename(executablePath, realExecutablePath);
            ...
            if (fileExists(launchScriptPath)) {
                let scriptContent = yield fs.readFile(launchScriptPath, 'utf8');
                // Replace the executable path in the script
                scriptContent = scriptContent.replace(/"\$game_dir\/Cyberpunk2077\.app\/Contents\/MacOS\/Cyberpunk2077"/g, '"$game_dir/Cyberpunk2077.app/Contents/MacOS/Cyberpunk2077_real"');
                // Step 3: Copy modified script as new executable
                yield fs.writeFile(newExecutablePath, scriptContent);
                // Step 4: Make it executable
                yield fs.chmod(newExecutablePath, 0o755);
...
class GameProcessManager {
    constructor(api, gameExecutableNames) {
        this.gameProcesses = new Set();
    ...
    isGameRunning() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const processes = yield this.getRunningProcesses();
                return processes.some(proc => this.gameExecutableNames.some(gameName => proc.toLowerCase().includes(gameName.toLowerCase())));
            }
            catch (error) {
    ...
    updateGameState() {
        return __awaiter(this, void 0, void 0, function* () {
            const isRunning = yield this.isGameRunning();
     ...
     */
    queueProfileSwitch(switchFunction) {
...
exports.GameProcessManager = GameProcessManager;
function getCyberpunkRedscriptAwareExecutable(discoveredPath) {
    if (process.platform !== 'darwin') {
...
exports.getCyberpunkRedscriptAwareExecutable = getCyberpunkRedscriptAwareExecutable;
 ...
 */
function validateCyberpunkMacOSCompatibility(modPath, modFiles) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.validateCyberpunkMacOSCompatibility = validateCyberpunkMacOSCompatibility;
/**
 ...
 */
function createMacOSCompatibilityErrorMessage(incompatibleItems) {
    const message = [
...
exports.hasWindowsOnlyFrameworks = hasWindowsOnlyFrameworks;
/**
 ...
 */
function detectLovelyInjectorForBalatro(gamePath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const lovelyFiles = [
                'liblovely.dylib',
            ...
            (0, log_1.log)('debug', 'Checking for Lovely injector in Balatro installation', {
                gamePath,
            ...
            for (const file of lovelyFiles) {
                ...
                if (yield fs.pathExists(filePath)) {
                    (0, log_1.log)('info', 'Lovely injector detected for Balatro', {
                        gamePath,
                        detectedFile: file,
                        filePath
                    });
            ...
            (0, log_1.log)('debug', 'Lovely injector not detected in Balatro installation', { gamePath });
            return false;
        }
        catch (error) {
            (0, log_1.log)('error', 'Error detecting Lovely injector for Balatro', {
                gamePath,
...
function detectSteamModdedForBalatro(gamePath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            (0, log_1.log)('debug', 'Checking for SteamModded in Balatro installation', {
                gamePath,
            ...
            for (const file of steamModdedFiles) {
                const filePath = path.join(gamePath, file);
                if (yield fs.pathExists(filePath)) {
                    (0, log_1.log)('info', 'SteamModded detected for Balatro', {
                        gamePath,
                        detectedFile: file,
                        filePath
                    });
            ...
            (0, log_1.log)('debug', 'SteamModded not detected in Balatro installation', { gamePath });
            return false;
        }
        catch (error) {
            (0, log_1.log)('error', 'Error detecting SteamModded for Balatro', {
                gamePath,
                error: error instanceof Error ? error.message : String(error),
                stack: error instanceof Error ? error.stack : undefined
            });
...
exports.detectSteamModdedForBalatro = detectSteamModdedForBalatro;
// Common executable name mappings for Windows to macOS
const EXECUTABLE_NAME_MAPPINGS = [
    // Generic mappings
    {
...
const customExecutableNameMappings = [];
/**
 * Register a custom executable name mapping for community extensions
 * @param mapping The executable name mapping to register
 */
function registerCustomExecutableNameMapping(mapping) {
    (0, log_1.log)('info', 'Registering custom executable name mapping for community extension', {
        description: mapping.description,
        windowsExecutable: mapping.windowsExecutable,
        macOSExecutable: mapping.macOSExecutable
    });
    // Check if mapping already exists
    const existingIndex = customExecutableNameMappings.findIndex(existing => existing.windowsExecutable === mapping.windowsExecutable &&
        existing.gameId === mapping.gameId);
    if (existingIndex >= 0) {
        (0, log_1.log)('warn', 'Overriding existing executable name mapping', {
            description: mapping.description,
...
exports.registerCustomExecutableNameMapping = registerCustomExecutableNameMapping;
/**
 ...
 */
function getExecutableNameMappings(gameId) {
...
exports.getExecutableNameMappings = getExecutableNameMappings;
/**
 ...
 */
function mapWindowsExecutableToMacOS(windowsExecutable, gameId) {
    if (!windowsExecutable) {
    ...
    const exactMatch = mappings.find(mapping => mapping.windowsExecutable.toLowerCase() === windowsExecutable.toLowerCase() ||
        mapping.windowsExecutable.toLowerCase() === baseName.toLowerCase());
    if (exactMatch) {
        (0, log_1.log)('debug', 'Found executable name mapping', {
            windowsExecutable,
    ...
    if (windowsExecutable.toLowerCase().endsWith('.exe')) {
        const genericMatch = mappings.find(mapping => mapping.windowsExecutable.toLowerCase() === baseName.toLowerCase());
        if (genericMatch) {
            (0, log_1.log)('debug', 'Found generic executable name mapping', {
                windowsExecutable,
...
exports.mapWindowsExecutableToMacOS = mapWindowsExecutableToMacOS;
/**
 * Validate an executable name mapping
 * @param mapping The mapping to validate
 * @returns Validation result with success status and any errors
 */
function validateExecutableNameMapping(mapping) {
    const errors = [];
    // Basic validation
...
exports.validateExecutableNameMapping = validateExecutableNameMapping;
function validateBalatroPlatformCompatibility(gamePath) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = {
            isValid: false,
        ...
        try {
            (0, log_1.log)('info', 'Validating Balatro installation for macOS compatibility', { gamePath });
            // Check if game path exists
            if (!(yield fs.pathExists(gamePath))) {
                result.errors.push('Game path does not exist');
                return result;
            }
            // Check for app bundle
            const appBundlePath = yield findMacOSAppBundle(gamePath, 'Balatro.app');
            if (appBundlePath) {
                result.appBundleFound = true;
                result.executablePath = yield getExecutableFromAppBundle(appBundlePath);
                (0, log_1.log)('info', 'Balatro app bundle found', { appBundlePath, executablePath: result.executablePath });
            }
            else {
                result.recommendations.push('Balatro.app bundle not found - game may not launch properly on macOS');
            }
            // Check for mod loaders
            result.hasLovelyInjector = yield detectLovelyInjectorForBalatro(gamePath);
            result.hasSteamModded = yield detectSteamModdedForBalatro(gamePath);
            ...
            (0, log_1.log)('info', 'Balatro compatibility validation completed', {
                gamePath,
                result: {
            ...
            (0, log_1.log)('error', 'Error validating Balatro installation', {
                gamePath,
                error: error instanceof Error ? error.message : String(error),
                stack: error instanceof Error ? error.stack : undefined
            });
...
exports.validateBalatroPlatformCompatibility = validateBalatroPlatformCompatibility;

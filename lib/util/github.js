...
class GitHub {
    ...
    query(baseUrl, request) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const options = Object.assign(Object.assign({}, _.pick(relUrl, ['port', 'hostname', 'path'])), { headers: {
    ...
    queryReleases() {
        return this.query(GitHub.repoUrl(), 'releases')
            ...
            if (!Array.isArray(releases)) {
                return Promise.reject(new CustomErrors_1.DataInvalid('expected array of github releases'));
            }

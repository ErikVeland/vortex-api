 ...
 * Replace with:
 */
export declare const promiseMap: <T, R>(array: T[], mapperFunction: (item: T, index: number) => Promise<R>) => Promise<R[]>;
/**
 * Promise-based sequential mapping implementation
 * Original: promise.mapSeries(array, mapperFunction)
 * Replace with:
 */
export declare const promiseMapSeries: <T, R>(array: T[], mapperFunction: (item: T, index: number) => Promise<R>) => Promise<R[]>;
/**

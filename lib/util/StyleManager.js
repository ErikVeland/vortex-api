...
class StyleManager {
    constructor(api) {
        ...
        this.mSetQueue = Promise.resolve();
    ...
    setSheet(key, filePath) {
        ...
        if (process.platform === 'darwin' && filePath && filePath.includes('macos-tahoe')) {
            (0, log_1.log)('info', '🔍 macOS Theme Diagnostics - StyleManager.setSheet', {
        ...
        try {
            const statProm = () => (filePath === undefined)
                ...
                : (path.extname(filePath) === '')
                    ? Promise.allSettled([fs.statAsync(filePath + '.scss'), fs.statAsync(filePath + '.css')])
                        ...
                        // Enhanced logging for macOS theme diagnostics
                        if (process.platform === 'darwin' && filePath && filePath.includes('macos-tahoe')) {
                            (0, log_1.log)('info', '🔍 macOS Theme Diagnostics - StyleManager.setSheet file resolution', {
                                timestamp: new Date().toISOString(),
                                filePath,
                                scssResult: (_a = results[0]) === null || _a === void 0 ? void 0 : _a.status,
                                cssResult: (_b = results[1]) === null || _b === void 0 ? void 0 : _b.status,
                                scssError: ((_c = results[0]) === null || _c === void 0 ? void 0 : _c.status) === 'rejected' ? (_e = (_d = results[0]) === null || _d === void 0 ? void 0 : _d.reason) === null || _e === void 0 ? void 0 : _e.message : 'N/A',
                                cssError: ((_f = results[1]) === null || _f === void 0 ? void 0 : _f.status) === 'rejected' ? (_h = (_g = results[1]) === null || _g === void 0 ? void 0 : _g.reason) === null || _h === void 0 ? void 0 : _h.message : 'N/A'
                            });
                        }
            ...
            this.mSetQueue = this.mSetQueue
                ...
                if (process.platform === 'darwin' && filePath && filePath.includes('macos-tahoe')) {
                    (0, log_1.log)('error', '❌ macOS Theme Diagnostics - StyleManager.setSheet FAILED', {
                        timestamp: new Date().toISOString(),
                        key,
                        filePath,
            ...
            // Enhanced error logging for macOS theme diagnostics
            if (process.platform === 'darwin' && filePath && filePath.includes('macos-tahoe')) {
                (0, log_1.log)('error', '💥 macOS Theme Diagnostics - StyleManager.setSheet EXCEPTION', {
                    timestamp: new Date().toISOString(),
                    key,
                    filePath,
                    errorMessage: err.message,
    ...
    renderNow() {
        this.mSetQueue = this.mSetQueue.then(() => new Promise((resolve, reject) => {
    ...
    render() {
        ...
        if (process.platform === 'darwin') {
            ...
            if (macOSStylesheets.length > 0) {
                (0, log_1.log)('info', '🔍 macOS Theme Diagnostics - StyleManager.render', {
                    timestamp: new Date().toISOString(),
        ...
        return new Promise((resolve, reject) => {
            ...
            if (process.platform === 'darwin') {
                ...
                if (hasMacOSTheme) {
                    (0, log_1.log)('info', '✅ macOS Theme Diagnostics - StyleManager.render SUCCESS', {
                        timestamp: new Date().toISOString(),
                        platform: process.platform,
                        cssLength: (css === null || css === void 0 ? void 0 : css.length) || 0,
                        hasMacOSTheme
            ...
            .catch((err) => {
            (0, log_1.log)('error', 'StyleManager render - FAILED', {
                errorMessage: err.message,
                errorStack: err.stack
            });
            // Enhanced error logging for macOS theme diagnostics
            if (process.platform === 'darwin') {
                const hasMacOSTheme = stylesheets.some(s => s.includes('macos-tahoe'));
                if (hasMacOSTheme) {
                    (0, log_1.log)('error', '❌ macOS Theme Diagnostics - StyleManager.render FAILED', {
                        timestamp: new Date().toISOString(),
                        platform: process.platform,
                        errorMessage: err.message,
                        errorStack: err.stack,

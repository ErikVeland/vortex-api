...
exports.getExecutableType = exports.isWindowsExecutable = exports.isAppBundle = exports.getGameExecutablePath = exports.getBestExecutableCandidate = exports.resolveGameExecutable = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const candidates = [
                ...
                path.join(basePath, 'Contents', 'MacOS', mappedExecutableName),

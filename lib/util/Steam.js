...
class Steam {
    constructor() {
        ...
        if ((0, platform_1.isWindows)()) {
            ...
            this.mBaseFolder = bluebird_1.default.resolve(this.findMacOSSteamPath());
        }
        else {
            // linux and others
    ...
    allGames() {
        ...
        return this.mCache.catch(err => {
            ...
            return bluebird_1.default.delay(200).then(() => {
                this.mCache = this.parseManifests();
                return this.mCache;
            });
        });
    ...
    parseManifests() {
        return this.resolveSteamPaths()
            ...
            return this.getAppLibraryMapping(steamPaths)
                .then((appLibraryMap) => {
                return bluebird_1.default.mapSeries(steamPaths, steamPath => {
    ...
    getAppLibraryMapping(steamPaths) {
        ...
        if (!mainSteamPath) {
            return bluebird_1.default.resolve(appLibraryMap);
        }

...
const activeGameId_2 = require("../extensions/profile_management/activeGameId");
const selectors_1 = require("../extensions/gamemode_management/selectors");
...
class QuickLauncher extends ComponentEx_1.ComponentEx {
    constructor(props) {
        ...
        this.start = () => {
            ...
            const profile = (0, activeGameId_1.activeProfile)(state);
    ...
    makeStarter(props) {
        ...
        if (!game || !gameDiscovery) {
            const cached = (_a = this.state) === null || _a === void 0 ? void 0 : _a.cachedGameState;
            if (cached) {
        ...
        try {
            if (!(0, util_1.truthy)(primaryTool)
                ...
                return new StarterInfo_1.default(effectiveGame, effectiveGameDiscovery);
            }
            else {
                try {
                    if ((0, util_1.truthy)(discoveredTools[primaryTool].path)) {
                        return new StarterInfo_1.default(effectiveGame, effectiveGameDiscovery, effectiveGame !== undefined ? effectiveGame.supportedTools[primaryTool] : undefined, discoveredTools[primaryTool]);
                    }
                    else {
...
function mapStateToProps(state) {
    const gameMode = (0, activeGameId_2.activeGameId)(state);
    return {
        gameMode,
